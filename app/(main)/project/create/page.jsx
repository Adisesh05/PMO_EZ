...
export default function CreateProjectPage() {
  ...
  const onSubmit = async (data) => {
    ...
    console.log('🚀 Creating project for organization:', organization.id);
    // Pass the organization ID as the second parameter
    createProjectFn(data, organization.id);
  };
    ...
    <div className="container mx-auto py-10">
      ...
      {organization && (
        <div className="mb-4 text-center text-sm text-gray-600">
          Creating project for: <strong>{organization.name}</strong>
        </div>
      )}
